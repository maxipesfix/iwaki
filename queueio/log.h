 ...
 * FILE: log.h
 *
 * ABSTRACT: This is a derivative of the logging code provided by
 * Petru Marginean from his article at Dr. Dobb's at
...
{
  /* TODO: make time stamp printing optional -- maxim */
    os << "- " << NowTime();
    os << " " << ToString(level) << ": ";
...
inline string getTimeStampDelimPadded() {
